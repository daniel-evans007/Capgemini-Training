...
public class CabController {
	...
	public ResponseEntity<String> deleteCab(@ApiParam(value = "Cab ID from which Cab object will be removed from the Database", required = true) @PathVariable("id") int id){
