...
public class TripBookingController {
	...
	public ResponseEntity<String> deleteTripBooking(@ApiParam(value = "Trip ID from which Trip object will be removed from the Database", required = true)  @PathVariable("id")int id) {
